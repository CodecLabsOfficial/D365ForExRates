...
namespace CodecLabs.ExRate.Workflows.Service
{
    internal class ExchangeRateAPI : BaseAPI, IApi
    {
        ...
        internal void CallCurrencyAction(IOrganizationService service, Entity item, ExchangeRate exr, string ignoreCases, string baseCurrencyCode, Guid exchangeIntegrationId)
        {
